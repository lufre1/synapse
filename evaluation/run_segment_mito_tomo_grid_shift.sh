...
EXPORT_PATH="/mnt/lustre-grete/usr/u12103/mitochondria/synapse-net-eval-data/eval_data_h5_s4_segment_grid_shift-test-6"
FORCE_OVERRIDE=True
...
python /user/freckmann15/u12103/synapse/evaluation/segment_mitochondria_grid_shift.py \
  --base_path ${DD} \
  --key ${RAW_KEY} \
