...
#SBATCH --job-name=inference-volume-em-4010-aniso2lvl
#SBATCH -c 8
#SBATCH --mem 256G
...
CONFIG_FILE_PATH="/mnt/vast-nhr/home/freckmann15/u15205/synapse/inference/mitochondria/segment_mitos_4010_aniso2lvl.yaml"
