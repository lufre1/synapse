...
# "mitotomo-net32-bs2-ps32512-lr1e-4-downscaled"
...
python /user/freckmann15/u12103/synapse/test.py \
  ...
  --file_path /scratch-grete/projects/nim00007/data/mitochondria/cooper/fidi/36859_J1_66K_TS_CA3_PS_52_rec_2Kb1dawbp_crop.h5
