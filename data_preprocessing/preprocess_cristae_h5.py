...
def process_mitos_and_cristae(data):
    # get the data 
...
def main():
    ...
    parser.add_argument("--base_path", "-b",  type=str, default="/home/freckmann15/data/mitochondria/cooper/fidi_2025/exported_to_hdf5_s2", help="Path to the root data directory")
    parser.add_argument("--export_path", "-e", type=str, default="/home/freckmann15/data/mitochondria/cooper/fidi_2025/raw_mitos_combined_s2", help="Path to the export directory")
