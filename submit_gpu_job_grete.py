#! /home/nimlufre/miniforge3/bin/python3.10
# NOTE: replace this with the path to your conda installation
# Example: Submit script with 4 threads, 2 GPUs, and 12-hour time limit
# python submit_slurm.py my_script.py n_threads=4 n_gpus=2 time_limit=720
