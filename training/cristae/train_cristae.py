...
SYNAPSENETV1_TEST_SPLIT = [
    ...
    "/mnt/lustre-grete/usr/u12103/cristae_data/wichmann_needs_corrections/2026-05-26-dataset/Otof_AVCN07_455L_KO_M.Stim_B3_2_35933_combined.h5",  # moved 2026-06-17 (poor labels); kept in test for AP comparability
    ...
    if args.split_file is not None:
        ...
        if args.split_strategy == "grouped_stratified":
            ...
            data = grouped_stratified_split(
                data_paths, val_ratio=0.15, seed=args.seed,
